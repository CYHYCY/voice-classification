...
class VoiceDataset(Dataset):
    def __init__(self, train_lines, image_size=(224, 224)):
        """
    ...
    def get_random_data(self, annotation_line, input_shape):
        ...
        """
        # line = annotation_line.split('.wav')  # 应对./data/JPGImages/img ().jpg 12 13 44 56 0的情况
        # line_path = line[0] + ".wav"
...
def voice_dataset_collate(batch):
    images = []
    bboxes = []
...
if __name__ == "__main__":
    ...
    train_dataset = VoiceDataset(lines[:num_train], (224, 224))
